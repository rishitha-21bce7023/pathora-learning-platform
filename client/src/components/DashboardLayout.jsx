...
const activeLinkClasses = 'bg-cyan-400/20 text-cyan-200';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto flex max-w-7xl gap-4 px-4 py-4 md:px-6 lg:px-8">
        <aside className="hidden w-72 shrink-0 rounded-3xl border border-slate-800 bg-slate-900/90 p-5 shadow-2xl shadow-cyan-950/30 md:block">
          <div className="space-y-6">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-cyan-300">Pathora</p>
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-950 p-4">
              ...
              <p className="mt-2 text-sm font-semibold text-cyan-200">{actions?.focus || 'Keep learning momentum strong'}</p>
            </div>
          </div>
        </aside>

        <div className="flex-1">
          <header className="rounded-3xl border border-slate-800 bg-slate-900/90 px-4 py-4 shadow-2xl shadow-cyan-950/30 md:px-6">
          ...
          <main className="mt-4 rounded-3xl border border-slate-800 bg-slate-900/80 p-4 shadow-2xl shadow-cyan-950/30 md:p-6">
            {children}
          </main>
        </div>
      </div>
